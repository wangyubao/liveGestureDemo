...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        imageType = a.getInt(R.styleable.CircleImageView_imageType, TYPE_CIRCLE);// 默认为Circle
        cornerRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_cornerRadius,
